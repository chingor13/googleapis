...
checkUnnamed1841(core.List<api.PagespeedApiFormatStringV2ArgsRects> o) {
...
buildPagespeedApiFormatStringV2Args() {
  ...
  if (buildCounterPagespeedApiFormatStringV2Args < 3) {
    o.key = "foo";
    o.rects = buildUnnamed1841();
    o.secondaryRects = buildUnnamed1842();
    o.type = "foo";
    o.value = "foo";
  }
  buildCounterPagespeedApiFormatStringV2Args--;
...
checkPagespeedApiFormatStringV2Args(api.PagespeedApiFormatStringV2Args o) {
  ...
  if (buildCounterPagespeedApiFormatStringV2Args < 3) {
    ...
    checkUnnamed1841(o.rects);
    checkUnnamed1842(o.secondaryRects);
...
checkUnnamed1843(core.List<api.PagespeedApiFormatStringV2Args> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1845(core.List<api.PagespeedApiFormatStringV2> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildResultFormattedResults() {
  ...
  if (buildCounterResultFormattedResults < 3) {
    o.locale = "foo";
    o.ruleResults = buildUnnamed1848();
  }
  buildCounterResultFormattedResults--;
  return o;
}
...
checkResultFormattedResults(api.ResultFormattedResults o) {
  ...
  if (buildCounterResultFormattedResults < 3) {
    ...
    checkUnnamed1848(o.ruleResults);
  }
  buildCounterResultFormattedResults--;
}
...
checkUnnamed1850(core.Map<core.String, api.ResultRuleGroupsValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildResult() {
  ...
  if (buildCounterResult < 3) {
    ...
    o.id = "foo";
    o.invalidRules = buildUnnamed1849();
    o.kind = "foo";
    o.pageStats = buildResultPageStats();
    o.responseCode = 42;
    o.ruleGroups = buildUnnamed1850();
