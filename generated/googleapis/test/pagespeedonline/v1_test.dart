...
buildResult() {
  ...
  if (buildCounterResult < 3) {
    ...
    o.id = "foo";
    o.invalidRules = buildUnnamed928();
    o.kind = "foo";
...
checkResult(api.Result o) {
  ...
  if (buildCounterResult < 3) {
    ...
    checkUnnamed928(o.invalidRules);
