...
buildActivityContentDetailsPromotedItem() {
  ...
  if (buildCounterActivityContentDetailsPromotedItem < 3) {
    ...
    o.forecastingUrl = buildUnnamed1232();
    o.impressionUrl = buildUnnamed1233();
    o.videoId = "foo";
  }
  buildCounterActivityContentDetailsPromotedItem--;
  return o;
...
checkActivityContentDetailsPromotedItem(
  ...
  if (buildCounterActivityContentDetailsPromotedItem < 3) {
    ...
    checkUnnamed1232(o.forecastingUrl);
    checkUnnamed1233(o.impressionUrl);
...
checkUnnamed1234(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed1235(core.List<api.Caption> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCaption(o[0]);
  checkCaption(o[1]);
}
...
checkUnnamed1236(core.Map<core.String, api.ChannelLocalization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChannel() {
  ...
  if (buildCounterChannel < 3) {
    ...
    o.kind = "foo";
    o.localizations = buildUnnamed1236();
...
checkChannel(api.Channel o) {
  ...
  if (buildCounterChannel < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1236(o.localizations);
...
checkUnnamed1237(core.List<api.PropertyValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1238(core.List<api.ChannelConversionPing> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1239(core.List<api.Channel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChannel(o[0]);
  checkChannel(o[1]);
}
...
checkUnnamed1240(core.Map<core.String, api.ChannelSectionLocalization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChannelSection() {
  ...
  if (buildCounterChannelSection < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.localizations = buildUnnamed1240();
...
checkChannelSection(api.ChannelSection o) {
  ...
  if (buildCounterChannelSection < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1240(o.localizations);
...
buildChannelSectionContentDetails() {
  ...
  if (buildCounterChannelSectionContentDetails < 3) {
    o.channels = buildUnnamed1241();
    o.playlists = buildUnnamed1242();
  }
  buildCounterChannelSectionContentDetails--;
  return o;
}
...
checkChannelSectionContentDetails(api.ChannelSectionContentDetails o) {
  buildCounterChannelSectionContentDetails++;
  if (buildCounterChannelSectionContentDetails < 3) {
    checkUnnamed1241(o.channels);
    checkUnnamed1242(o.playlists);
  }
  buildCounterChannelSectionContentDetails--;
}
...
checkUnnamed1243(core.List<api.ChannelSection> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChannelSectionTargeting() {
  ...
  if (buildCounterChannelSectionTargeting < 3) {
    o.countries = buildUnnamed1244();
    o.languages = buildUnnamed1245();
    o.regions = buildUnnamed1246();
  }
  buildCounterChannelSectionTargeting--;
  return o;
}
...
checkChannelSectionTargeting(api.ChannelSectionTargeting o) {
  buildCounterChannelSectionTargeting++;
  if (buildCounterChannelSectionTargeting < 3) {
    checkUnnamed1244(o.countries);
    checkUnnamed1245(o.languages);
    checkUnnamed1246(o.regions);
  }
  buildCounterChannelSectionTargeting--;
}
...
buildChannelSettings() {
  ...
  if (buildCounterChannelSettings < 3) {
    ...
    o.featuredChannelsUrls = buildUnnamed1247();
    o.keywords = "foo";
...
checkChannelSettings(api.ChannelSettings o) {
  ...
  if (buildCounterChannelSettings < 3) {
    ...
    checkUnnamed1247(o.featuredChannelsUrls);
...
buildChannelTopicDetails() {
  ...
  if (buildCounterChannelTopicDetails < 3) {
    o.topicCategories = buildUnnamed1248();
    o.topicIds = buildUnnamed1249();
  }
  buildCounterChannelTopicDetails--;
  return o;
}
...
checkChannelTopicDetails(api.ChannelTopicDetails o) {
  buildCounterChannelTopicDetails++;
  if (buildCounterChannelTopicDetails < 3) {
    checkUnnamed1248(o.topicCategories);
    checkUnnamed1249(o.topicIds);
  }
  buildCounterChannelTopicDetails--;
}
...
checkUnnamed1250(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed1251(core.List<api.CommentThread> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1252(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
buildContentRating() {
  ...
  if (buildCounterContentRating < 3) {
    ...
    o.czfilmRating = "foo";
    o.djctqRating = "foo";
    o.djctqRatingReasons = buildUnnamed1253();
    o.ecbmctRating = "foo";
    o.eefilmRating = "foo";
    o.egfilmRating = "foo";
    o.eirinRating = "foo";
    ...
    o.fmocRating = "foo";
    o.fpbRating = "foo";
    o.fpbRatingReasons = buildUnnamed1254();
    o.fskRating = "foo";
    o.grfilmRating = "foo";
    o.icaaRating = "foo";
    o.ifcoRating = "foo";
...
checkContentRating(api.ContentRating o) {
  ...
  if (buildCounterContentRating < 3) {
    ...
    checkUnnamed1253(o.djctqRatingReasons);
    ...
    checkUnnamed1254(o.fpbRatingReasons);
...
checkUnnamed1255(core.List<api.GuideCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1256(core.List<api.I18nLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1257(core.List<api.I18nRegion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkI18nRegion(o[0]);
  checkI18nRegion(o[1]);
}
...
checkUnnamed1258(core.List<api.PromotedItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1259(core.List<api.LiveBroadcast> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1260(core.List<api.LiveChatMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1261(core.List<api.LiveChatModerator> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1262(core.List<api.LiveChatPollItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1263(core.List<api.LiveChatPollItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLiveChatPollItem(o[0]);
  checkLiveChatPollItem(o[1]);
}
...
checkUnnamed1264(core.List<api.LiveStreamConfigurationIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLiveStreamHealthStatus() {
  ...
  if (buildCounterLiveStreamHealthStatus < 3) {
    o.configurationIssues = buildUnnamed1264();
...
checkLiveStreamHealthStatus(api.LiveStreamHealthStatus o) {
  buildCounterLiveStreamHealthStatus++;
  if (buildCounterLiveStreamHealthStatus < 3) {
    checkUnnamed1264(o.configurationIssues);
...
checkUnnamed1265(core.List<api.LiveStream> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLiveStream(o[0]);
  checkLiveStream(o[1]);
}
...
checkUnnamed1266(core.List<api.LocalizedString> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1267(core.Map<core.String, api.PlaylistLocalization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPlaylist() {
  ...
  if (buildCounterPlaylist < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.localizations = buildUnnamed1267();
...
checkPlaylist(api.Playlist o) {
  ...
  if (buildCounterPlaylist < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1267(o.localizations);
...
checkUnnamed1268(core.List<api.PlaylistItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1269(core.List<api.Playlist> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlaylist(o[0]);
  checkPlaylist(o[1]);
}
...
checkUnnamed1271(core.List<api.SearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1272(core.List<api.Sponsor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSponsor(o[0]);
  checkSponsor(o[1]);
}
...
checkUnnamed1273(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1274(core.List<api.SuperChatEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1275(core.List<api.ThumbnailDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1276(core.Map<core.String, api.VideoLocalization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideo() {
  ...
  if (buildCounterVideo < 3) {
    ...
    o.localizations = buildUnnamed1276();
...
checkVideo(api.Video o) {
  ...
  if (buildCounterVideo < 3) {
    ...
    checkUnnamed1276(o.localizations);
...
checkUnnamed1277(core.List<api.VideoAbuseReportReason> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1278(core.List<api.VideoAbuseReportSecondaryReason> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideoAbuseReportReasonSnippet() {
  ...
  if (buildCounterVideoAbuseReportReasonSnippet < 3) {
    o.label = "foo";
    o.secondaryReasons = buildUnnamed1278();
  }
  buildCounterVideoAbuseReportReasonSnippet--;
  return o;
}
...
checkVideoAbuseReportReasonSnippet(api.VideoAbuseReportReasonSnippet o) {
  ...
  if (buildCounterVideoAbuseReportReasonSnippet < 3) {
    ...
    checkUnnamed1278(o.secondaryReasons);
  }
  buildCounterVideoAbuseReportReasonSnippet--;
}
...
checkUnnamed1279(core.List<api.VideoCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideoContentDetailsRegionRestriction() {
  ...
  if (buildCounterVideoContentDetailsRegionRestriction < 3) {
    o.allowed = buildUnnamed1280();
    o.blocked = buildUnnamed1281();
  }
  buildCounterVideoContentDetailsRegionRestriction--;
  return o;
}
...
checkVideoContentDetailsRegionRestriction(
  ...
  buildCounterVideoContentDetailsRegionRestriction++;
  if (buildCounterVideoContentDetailsRegionRestriction < 3) {
    checkUnnamed1280(o.allowed);
    checkUnnamed1281(o.blocked);
  }
  buildCounterVideoContentDetailsRegionRestriction--;
}
...
checkUnnamed1282(core.List<api.VideoFileDetailsAudioStream> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1283(core.List<api.VideoFileDetailsVideoStream> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideoFileDetails() {
  ...
  if (buildCounterVideoFileDetails < 3) {
    o.audioStreams = buildUnnamed1282();
    o.bitrateBps = "foo";
    o.container = "foo";
    o.creationTime = "foo";
    o.durationMs = "foo";
    ...
    o.fileSize = "foo";
    o.fileType = "foo";
    o.videoStreams = buildUnnamed1283();
  }
  buildCounterVideoFileDetails--;
  return o;
}
...
checkVideoFileDetails(api.VideoFileDetails o) {
  buildCounterVideoFileDetails++;
  if (buildCounterVideoFileDetails < 3) {
    checkUnnamed1282(o.audioStreams);
    ...
    checkUnnamed1283(o.videoStreams);
  }
  buildCounterVideoFileDetails--;
}
...
checkUnnamed1284(core.List<api.VideoRating> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1285(core.List<api.Video> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVideo(o[0]);
  checkVideo(o[1]);
}
...
checkUnnamed1292(core.List<api.VideoSuggestionsTagSuggestion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideoSuggestions() {
  ...
  if (buildCounterVideoSuggestions < 3) {
    o.editorSuggestions = buildUnnamed1288();
    o.processingErrors = buildUnnamed1289();
    o.processingHints = buildUnnamed1290();
    o.processingWarnings = buildUnnamed1291();
    o.tagSuggestions = buildUnnamed1292();
  }
  buildCounterVideoSuggestions--;
  return o;
}
...
checkVideoSuggestions(api.VideoSuggestions o) {
  buildCounterVideoSuggestions++;
  if (buildCounterVideoSuggestions < 3) {
    checkUnnamed1288(o.editorSuggestions);
    checkUnnamed1289(o.processingErrors);
    checkUnnamed1290(o.processingHints);
    checkUnnamed1291(o.processingWarnings);
    checkUnnamed1292(o.tagSuggestions);
  }
  buildCounterVideoSuggestions--;
}
...
buildVideoSuggestionsTagSuggestion() {
  ...
  if (buildCounterVideoSuggestionsTagSuggestion < 3) {
    o.categoryRestricts = buildUnnamed1293();
    o.tag = "foo";
  }
  buildCounterVideoSuggestionsTagSuggestion--;
  return o;
...
checkVideoSuggestionsTagSuggestion(api.VideoSuggestionsTagSuggestion o) {
  buildCounterVideoSuggestionsTagSuggestion++;
  if (buildCounterVideoSuggestionsTagSuggestion < 3) {
    checkUnnamed1293(o.categoryRestricts);
...
buildVideoTopicDetails() {
  ...
  if (buildCounterVideoTopicDetails < 3) {
    o.relevantTopicIds = buildUnnamed1294();
    o.topicCategories = buildUnnamed1295();
    o.topicIds = buildUnnamed1296();
  }
  buildCounterVideoTopicDetails--;
  return o;
}
...
checkVideoTopicDetails(api.VideoTopicDetails o) {
  buildCounterVideoTopicDetails++;
  if (buildCounterVideoTopicDetails < 3) {
    checkUnnamed1294(o.relevantTopicIds);
    checkUnnamed1295(o.topicCategories);
    checkUnnamed1296(o.topicIds);
  }
  buildCounterVideoTopicDetails--;
}
