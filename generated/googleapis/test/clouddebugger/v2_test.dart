...
checkUnnamed1036(core.List<api.Variable> o) {
...
checkUnnamed1039(core.List<api.StackFrame> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStackFrame(o[0]);
  checkStackFrame(o[1]);
}
...
checkUnnamed1040(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}
...
buildBreakpoint() {
  ...
  if (buildCounterBreakpoint < 3) {
    ...
    o.condition = "foo";
    o.createTime = "foo";
    o.evaluatedExpressions = buildUnnamed1036();
    o.expressions = buildUnnamed1037();
    o.finalTime = "foo";
    o.id = "foo";
    o.isFinalState = true;
    o.labels = buildUnnamed1038();
    o.location = buildSourceLocation();
    o.logLevel = "foo";
    o.logMessageFormat = "foo";
    o.stackFrames = buildUnnamed1039();
    o.status = buildStatusMessage();
    o.userEmail = "foo";
    o.variableTable = buildUnnamed1040();
  }
  buildCounterBreakpoint--;
  return o;
}
...
checkBreakpoint(api.Breakpoint o) {
  ...
  if (buildCounterBreakpoint < 3) {
    ...
    checkUnnamed1039(o.stackFrames);
    checkStatusMessage(o.status);
    unittest.expect(o.userEmail, unittest.equals('foo'));
    checkUnnamed1040(o.variableTable);
  }
  buildCounterBreakpoint--;
}
...
checkUnnamed1041(core.List<api.ExtendedSourceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1042(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed1043(core.List<api.SourceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDebuggee() {
  ...
  if (buildCounterDebuggee < 3) {
    o.agentVersion = "foo";
    o.description = "foo";
    o.extSourceContexts = buildUnnamed1041();
    o.id = "foo";
    o.isDisabled = true;
    o.isInactive = true;
    o.labels = buildUnnamed1042();
    o.project = "foo";
    o.sourceContexts = buildUnnamed1043();
    o.status = buildStatusMessage();
    o.uniquifier = "foo";
  }
  buildCounterDebuggee--;
...
checkDebuggee(api.Debuggee o) {
  ...
  if (buildCounterDebuggee < 3) {
    ...
    checkUnnamed1041(o.extSourceContexts);
    unittest.expect(o.id, unittest.equals('foo'));
    ...
    checkUnnamed1043(o.sourceContexts);
    checkStatusMessage(o.status);
...
checkUnnamed1046(core.List<api.Breakpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBreakpoint(o[0]);
  checkBreakpoint(o[1]);
}
...
buildListActiveBreakpointsResponse() {
  ...
  if (buildCounterListActiveBreakpointsResponse < 3) {
    o.breakpoints = buildUnnamed1046();
    o.nextWaitToken = "foo";
    o.waitExpired = true;
  }
  buildCounterListActiveBreakpointsResponse--;
...
checkListActiveBreakpointsResponse(api.ListActiveBreakpointsResponse o) {
  buildCounterListActiveBreakpointsResponse++;
  if (buildCounterListActiveBreakpointsResponse < 3) {
    checkUnnamed1046(o.breakpoints);
...
checkUnnamed1047(core.List<api.Breakpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBreakpoint(o[0]);
  checkBreakpoint(o[1]);
}
...
buildListBreakpointsResponse() {
  ...
  if (buildCounterListBreakpointsResponse < 3) {
    o.breakpoints = buildUnnamed1047();
    o.nextWaitToken = "foo";
  }
  buildCounterListBreakpointsResponse--;
  return o;
...
checkListBreakpointsResponse(api.ListBreakpointsResponse o) {
  buildCounterListBreakpointsResponse++;
  if (buildCounterListBreakpointsResponse < 3) {
    checkUnnamed1047(o.breakpoints);
    unittest.expect(o.nextWaitToken, unittest.equals('foo'));
  }
  buildCounterListBreakpointsResponse--;
}
...
checkUnnamed1048(core.List<api.Debuggee> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDebuggee(o[0]);
  checkDebuggee(o[1]);
}
...
checkUnnamed1049(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}
...
checkUnnamed1050(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}
...
buildStackFrame() {
  ...
  if (buildCounterStackFrame < 3) {
    o.arguments = buildUnnamed1049();
    o.function = "foo";
    o.locals = buildUnnamed1050();
    o.location = buildSourceLocation();
  }
  buildCounterStackFrame--;
  return o;
...
checkStackFrame(api.StackFrame o) {
  buildCounterStackFrame++;
  if (buildCounterStackFrame < 3) {
    checkUnnamed1049(o.arguments);
    unittest.expect(o.function, unittest.equals('foo'));
    checkUnnamed1050(o.locals);
    checkSourceLocation(o.location);
  }
  buildCounterStackFrame--;
}
...
checkUnnamed1051(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}
