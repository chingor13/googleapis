...
checkUnnamed3800(core.List<api.AclRule> o) {
...
checkUnnamed3801(core.List<api.CalendarListEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3802(core.List<api.EventReminder> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3803(core.List<api.CalendarNotification> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCalendarListEntryNotificationSettings() {
  ...
  if (buildCounterCalendarListEntryNotificationSettings < 3) {
    o.notifications = buildUnnamed3803();
  }
  buildCounterCalendarListEntryNotificationSettings--;
  return o;
}
...
checkCalendarListEntryNotificationSettings(
  ...
  buildCounterCalendarListEntryNotificationSettings++;
  if (buildCounterCalendarListEntryNotificationSettings < 3) {
    checkUnnamed3803(o.notifications);
  }
  buildCounterCalendarListEntryNotificationSettings--;
}
...
buildCalendarListEntry() {
  ...
  if (buildCounterCalendarListEntry < 3) {
    ...
    o.colorId = "foo";
    o.conferenceProperties = buildConferenceProperties();
    o.defaultReminders = buildUnnamed3802();
    o.deleted = true;
    o.description = "foo";
    o.etag = "foo";
...
checkCalendarListEntry(api.CalendarListEntry o) {
  ...
  if (buildCounterCalendarListEntry < 3) {
    ...
    checkConferenceProperties(o.conferenceProperties);
    checkUnnamed3802(o.defaultReminders);
...
checkUnnamed3804(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3805(core.Map<core.String, api.ColorDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3806(core.Map<core.String, api.ColorDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColorDefinition(o["x"]);
  checkColorDefinition(o["y"]);
}
...
buildColors() {
  ...
  if (buildCounterColors < 3) {
    o.calendar = buildUnnamed3805();
    o.event = buildUnnamed3806();
    o.kind = "foo";
...
checkColors(api.Colors o) {
  buildCounterColors++;
  if (buildCounterColors < 3) {
    checkUnnamed3805(o.calendar);
    checkUnnamed3806(o.event);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(
...
checkUnnamed3807(core.List<api.EntryPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntryPoint(o[0]);
  checkEntryPoint(o[1]);
}
...
buildConferenceData() {
  ...
  if (buildCounterConferenceData < 3) {
    ...
    o.entryPoints = buildUnnamed3807();
    o.notes = "foo";
...
checkConferenceData(api.ConferenceData o) {
  ...
  if (buildCounterConferenceData < 3) {
    ...
    checkUnnamed3807(o.entryPoints);
...
buildConferenceProperties() {
  ...
  if (buildCounterConferenceProperties < 3) {
    o.allowedConferenceSolutionTypes = buildUnnamed3809();
  }
  buildCounterConferenceProperties--;
  return o;
}
...
checkConferenceProperties(api.ConferenceProperties o) {
  buildCounterConferenceProperties++;
  if (buildCounterConferenceProperties < 3) {
    checkUnnamed3809(o.allowedConferenceSolutionTypes);
  }
  buildCounterConferenceProperties--;
}
...
checkUnnamed3810(core.List<api.EventAttachment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3811(core.List<api.EventAttendee> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3813(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildEventExtendedProperties() {
  ...
  if (buildCounterEventExtendedProperties < 3) {
    o.private = buildUnnamed3812();
    o.shared = buildUnnamed3813();
  }
  buildCounterEventExtendedProperties--;
  return o;
}
...
checkEventExtendedProperties(api.EventExtendedProperties o) {
  buildCounterEventExtendedProperties++;
  if (buildCounterEventExtendedProperties < 3) {
    checkUnnamed3812(o.private);
    checkUnnamed3813(o.shared);
  }
  buildCounterEventExtendedProperties--;
}
...
buildEventGadget() {
  ...
  if (buildCounterEventGadget < 3) {
    ...
    o.iconLink = "foo";
    o.link = "foo";
    o.preferences = buildUnnamed3814();
    o.title = "foo";
    o.type = "foo";
    o.width = 42;
  }
...
checkEventGadget(api.EventGadget o) {
  ...
  if (buildCounterEventGadget < 3) {
    ...
    checkUnnamed3814(o.preferences);
...
checkUnnamed3816(core.List<api.EventReminder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventReminder(o[0]);
  checkEventReminder(o[1]);
}
...
buildEvent() {
  ...
  if (buildCounterEvent < 3) {
    ...
    o.attachments = buildUnnamed3810();
    o.attendees = buildUnnamed3811();
...
checkEvent(api.Event o) {
  ...
  if (buildCounterEvent < 3) {
    ...
    checkUnnamed3810(o.attachments);
    checkUnnamed3811(o.attendees);
...
checkUnnamed3817(core.List<api.EventReminder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventReminder(o[0]);
  checkEventReminder(o[1]);
}
...
checkUnnamed3818(core.List<api.Event> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEvent(o[0]);
  checkEvent(o[1]);
}
...
buildEvents() {
  ...
  if (buildCounterEvents < 3) {
    o.accessRole = "foo";
    o.defaultReminders = buildUnnamed3817();
    o.description = "foo";
    o.etag = "foo";
...
checkEvents(api.Events o) {
  ...
  if (buildCounterEvents < 3) {
    unittest.expect(o.accessRole, unittest.equals('foo'));
    checkUnnamed3817(o.defaultReminders);
    unittest.expect(o.description, unittest.equals('foo'));
    unittest.expect(o.etag, unittest.equals('foo'));
...
checkUnnamed3819(core.List<api.TimePeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimePeriod(o[0]);
  checkTimePeriod(o[1]);
}
...
checkUnnamed3820(core.List<api.Error> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkError(o[0]);
  checkError(o[1]);
}
...
buildFreeBusyCalendar() {
  ...
  if (buildCounterFreeBusyCalendar < 3) {
    o.busy = buildUnnamed3819();
    o.errors = buildUnnamed3820();
  }
  buildCounterFreeBusyCalendar--;
  return o;
}
...
checkFreeBusyCalendar(api.FreeBusyCalendar o) {
  buildCounterFreeBusyCalendar++;
  if (buildCounterFreeBusyCalendar < 3) {
    checkUnnamed3819(o.busy);
    checkUnnamed3820(o.errors);
  }
  buildCounterFreeBusyCalendar--;
}
...
checkUnnamed3822(core.List<api.Error> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkError(o[0]);
  checkError(o[1]);
}
...
checkUnnamed3823(core.List<api.FreeBusyRequestItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3824(core.Map<core.String, api.FreeBusyCalendar> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3825(core.Map<core.String, api.FreeBusyGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFreeBusyResponse() {
  ...
  if (buildCounterFreeBusyResponse < 3) {
    o.calendars = buildUnnamed3824();
    o.groups = buildUnnamed3825();
    o.kind = "foo";
    o.timeMax = core.DateTime.parse("2002-02-27T14:01:02");
    o.timeMin = core.DateTime.parse("2002-02-27T14:01:02");
  }
...
checkFreeBusyResponse(api.FreeBusyResponse o) {
  buildCounterFreeBusyResponse++;
  if (buildCounterFreeBusyResponse < 3) {
    checkUnnamed3824(o.calendars);
    checkUnnamed3825(o.groups);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(
        o.timeMax, unittest.equals(core.DateTime.parse("2002-02-27T14:01:02")));
    unittest.expect(
...
checkUnnamed3826(core.List<api.Setting> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSetting(o[0]);
  checkSetting(o[1]);
}
...
main() {
  ...
  unittest.group("resource-EventsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_orderBy = "foo";
      var arg_pageToken = "foo";
      var arg_privateExtendedProperty = buildUnnamed3827();
      var arg_q = "foo";
      var arg_sharedExtendedProperty = buildUnnamed3828();
      var arg_showDeleted = true;
    ...
    unittest.test("method--watch", () {
      ...
      var arg_orderBy = "foo";
      var arg_pageToken = "foo";
      var arg_privateExtendedProperty = buildUnnamed3829();
      var arg_q = "foo";
      var arg_sharedExtendedProperty = buildUnnamed3830();
      var arg_showDeleted = true;
      var arg_showHiddenInvitations = true;
      var arg_singleEvents = true;
      var arg_syncToken = "foo";
