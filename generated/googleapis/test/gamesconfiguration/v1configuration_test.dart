...
checkUnnamed2623(core.List<api.AchievementConfiguration> o) {
...
checkUnnamed2624(core.List<api.LeaderboardConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2625(core.List<api.LocalizedString> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLocalizedStringBundle() {
  ...
  if (buildCounterLocalizedStringBundle < 3) {
    o.kind = "foo";
    o.translations = buildUnnamed2625();
  }
  buildCounterLocalizedStringBundle--;
  return o;
}
...
checkLocalizedStringBundle(api.LocalizedStringBundle o) {
  ...
  if (buildCounterLocalizedStringBundle < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed2625(o.translations);
  }
  buildCounterLocalizedStringBundle--;
}
