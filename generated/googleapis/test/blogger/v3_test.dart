...
checkUnnamed2660(core.List<api.Post> o) {
...
checkUnnamed2661(core.List<api.BlogUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2662(core.List<api.Blog> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBlog(o[0]);
  checkBlog(o[1]);
}
...
buildBlogList() {
  ...
  if (buildCounterBlogList < 3) {
    o.blogUserInfos = buildUnnamed2661();
    o.items = buildUnnamed2662();
    o.kind = "foo";
  }
  buildCounterBlogList--;
  return o;
...
checkBlogList(api.BlogList o) {
  buildCounterBlogList++;
  if (buildCounterBlogList < 3) {
    checkUnnamed2661(o.blogUserInfos);
    checkUnnamed2662(o.items);
    unittest.expect(o.kind, unittest.equals('foo'));
  }
  buildCounterBlogList--;
}
...
checkUnnamed2663(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed2664(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed2665(core.List<api.PageviewsCounts> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2666(core.List<api.PostImages> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPostImages(o[0]);
  checkPostImages(o[1]);
}
...
checkUnnamed2668(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed2669(core.List<api.Post> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPost(o[0]);
  checkPost(o[1]);
}
...
checkUnnamed2670(core.List<api.PostUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
main() {
  ...
  unittest.group("resource-BlogsResourceApi", () {
    ...
    unittest.test("method--listByUser", () {
      ...
      var arg_role = buildUnnamed2671();
      var arg_status = buildUnnamed2672();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-CommentsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_status = buildUnnamed2673();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
    ...
    unittest.test("method--listByBlog", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed2674();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-PageViewsResourceApi", () {
    unittest.test("method--get", () {
      ...
      var arg_blogId = "foo";
      var arg_range = buildUnnamed2675();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-PagesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_maxResults = 42;
      var arg_pageToken = "foo";
      var arg_status = buildUnnamed2676();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-PostUserInfosResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed2677();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-PostsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed2678();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
