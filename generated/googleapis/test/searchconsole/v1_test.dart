...
checkUnnamed2113(core.List<api.MobileFriendlyIssue> o) {
...
checkUnnamed2114(core.List<api.ResourceIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRunMobileFriendlyTestResponse() {
  ...
  if (buildCounterRunMobileFriendlyTestResponse < 3) {
    ...
    o.mobileFriendlyIssues = buildUnnamed2113();
    o.resourceIssues = buildUnnamed2114();
...
checkRunMobileFriendlyTestResponse(api.RunMobileFriendlyTestResponse o) {
  ...
  if (buildCounterRunMobileFriendlyTestResponse < 3) {
    ...
    checkUnnamed2113(o.mobileFriendlyIssues);
    checkUnnamed2114(o.resourceIssues);
