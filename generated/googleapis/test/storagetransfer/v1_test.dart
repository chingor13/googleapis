...
buildErrorLogEntry() {
  ...
  if (buildCounterErrorLogEntry < 3) {
    o.errorDetails = buildUnnamed3341();
    o.url = "foo";
  }
  buildCounterErrorLogEntry--;
  return o;
...
checkErrorLogEntry(api.ErrorLogEntry o) {
  buildCounterErrorLogEntry++;
  if (buildCounterErrorLogEntry < 3) {
    checkUnnamed3341(o.errorDetails);
...
checkUnnamed3342(core.List<api.ErrorLogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildErrorSummary() {
  ...
  if (buildCounterErrorSummary < 3) {
    o.errorCode = "foo";
    o.errorCount = "foo";
    o.errorLogEntries = buildUnnamed3342();
  }
  buildCounterErrorSummary--;
  return o;
}
...
checkErrorSummary(api.ErrorSummary o) {
  ...
  if (buildCounterErrorSummary < 3) {
    ...
    checkUnnamed3342(o.errorLogEntries);
  }
  buildCounterErrorSummary--;
}
...
checkUnnamed3343(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed3344(core.List<api.TransferJob> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListTransferJobsResponse() {
  ...
  if (buildCounterListTransferJobsResponse < 3) {
    o.nextPageToken = "foo";
    o.transferJobs = buildUnnamed3344();
  }
  buildCounterListTransferJobsResponse--;
  return o;
}
...
checkListTransferJobsResponse(api.ListTransferJobsResponse o) {
  ...
  if (buildCounterListTransferJobsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3344(o.transferJobs);
  }
  buildCounterListTransferJobsResponse--;
}
...
buildObjectConditions() {
  ...
  if (buildCounterObjectConditions < 3) {
    o.excludePrefixes = buildUnnamed3345();
    o.includePrefixes = buildUnnamed3346();
...
checkObjectConditions(api.ObjectConditions o) {
  buildCounterObjectConditions++;
  if (buildCounterObjectConditions < 3) {
    checkUnnamed3345(o.excludePrefixes);
    checkUnnamed3346(o.includePrefixes);
    unittest.expect(
...
checkUnnamed3347(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed3347();
    o.name = "foo";
    o.response = buildUnnamed3348();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed3347(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed3348(o.response);
  }
  buildCounterOperation--;
}
...
buildUnnamed3350() {
  ...
  o.add(buildUnnamed3349());
  o.add(buildUnnamed3349());
  return o;
}

checkUnnamed3350(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3349(o[0]);
  checkUnnamed3349(o[1]);
}
...
checkUnnamed3351(core.List<api.ErrorSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTransferOperation() {
  ...
  if (buildCounterTransferOperation < 3) {
    ...
    o.endTime = "foo";
    o.errorBreakdowns = buildUnnamed3351();
    o.name = "foo";
    o.projectId = "foo";
    o.startTime = "foo";
    o.status = "foo";
...
checkTransferOperation(api.TransferOperation o) {
  ...
  if (buildCounterTransferOperation < 3) {
    ...
    checkUnnamed3351(o.errorBreakdowns);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.projectId, unittest.equals('foo'));
