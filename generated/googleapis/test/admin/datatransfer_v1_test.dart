...
checkUnnamed471(core.List<api.ApplicationTransferParam> o) {
...
buildApplication() {
  ...
  if (buildCounterApplication < 3) {
    ...
    o.kind = "foo";
    o.name = "foo";
    o.transferParams = buildUnnamed471();
  }
  buildCounterApplication--;
  return o;
}
...
checkApplication(api.Application o) {
  ...
  if (buildCounterApplication < 3) {
    ...
    checkUnnamed471(o.transferParams);
  }
  buildCounterApplication--;
}
...
checkUnnamed472(core.List<api.ApplicationTransferParam> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApplicationTransferParam(o[0]);
  checkApplicationTransferParam(o[1]);
}
...
buildApplicationDataTransfer() {
  ...
  if (buildCounterApplicationDataTransfer < 3) {
    o.applicationId = "foo";
    o.applicationTransferParams = buildUnnamed472();
...
checkApplicationDataTransfer(api.ApplicationDataTransfer o) {
  ...
  if (buildCounterApplicationDataTransfer < 3) {
    ...
    checkUnnamed472(o.applicationTransferParams);
...
checkUnnamed474(core.List<api.Application> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed475(core.List<api.ApplicationDataTransfer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDataTransfer() {
  ...
  if (buildCounterDataTransfer < 3) {
    o.applicationDataTransfers = buildUnnamed475();
    o.etag = "foo";
    o.id = "foo";
    o.kind = "foo";
...
checkDataTransfer(api.DataTransfer o) {
  buildCounterDataTransfer++;
  if (buildCounterDataTransfer < 3) {
    checkUnnamed475(o.applicationDataTransfers);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed476(core.List<api.DataTransfer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDataTransfersListResponse() {
  ...
  if (buildCounterDataTransfersListResponse < 3) {
    o.dataTransfers = buildUnnamed476();
    o.etag = "foo";
    o.kind = "foo";
    o.nextPageToken = "foo";
  }
...
checkDataTransfersListResponse(api.DataTransfersListResponse o) {
  buildCounterDataTransfersListResponse++;
  if (buildCounterDataTransfersListResponse < 3) {
    checkUnnamed476(o.dataTransfers);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
