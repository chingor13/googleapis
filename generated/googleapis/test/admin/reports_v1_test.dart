...
checkUnnamed399(core.List<api.Activity> o) {
...
buildActivityEventsParameters() {
  ...
  if (buildCounterActivityEventsParameters < 3) {
    o.boolValue = true;
    o.intValue = "foo";
    o.multiIntValue = buildUnnamed400();
    o.multiValue = buildUnnamed401();
    o.name = "foo";
    o.value = "foo";
  }
  buildCounterActivityEventsParameters--;
...
checkActivityEventsParameters(api.ActivityEventsParameters o) {
  ...
  if (buildCounterActivityEventsParameters < 3) {
    ...
    checkUnnamed400(o.multiIntValue);
    checkUnnamed401(o.multiValue);
...
checkUnnamed402(core.List<api.ActivityEventsParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed403(core.List<api.ActivityEvents> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed404(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed406() {
  ...
  o.add(buildUnnamed405());
  o.add(buildUnnamed405());
  return o;
}

checkUnnamed406(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed405(o[0]);
  checkUnnamed405(o[1]);
}
...
checkUnnamed407(core.List<api.UsageReportParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed408(core.List<api.UsageReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed409(core.List<api.UsageReportsWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed410(core.List<api.UsageReportsWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUsageReports() {
  ...
  if (buildCounterUsageReports < 3) {
    ...
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.usageReports = buildUnnamed408();
...
checkUsageReports(api.UsageReports o) {
  ...
  if (buildCounterUsageReports < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed408(o.usageReports);
