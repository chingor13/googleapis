...
checkUnnamed930(core.List<core.Object> o) {
...
buildAppAccessCollections() {
  ...
  if (buildCounterAppAccessCollections < 3) {
    o.blockedApiAccessBuckets = buildUnnamed931();
...
checkAppAccessCollections(api.AppAccessCollections o) {
  buildCounterAppAccessCollections++;
  if (buildCounterAppAccessCollections < 3) {
    checkUnnamed931(o.blockedApiAccessBuckets);
...
checkUnnamed932(core.List<api.Asp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAsp(o[0]);
  checkAsp(o[1]);
}
...
checkUnnamed934(core.List<api.Building> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuilding(o[0]);
  checkBuilding(o[1]);
}
...
checkUnnamed935(core.List<api.CalendarResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed937(core.List<api.ChromeOsDeviceActiveTimeRanges> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed938(core.List<api.ChromeOsDeviceDeviceFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed939(core.List<api.ChromeOsDeviceRecentUsers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChromeOsDevice() {
  ...
  if (buildCounterChromeOsDevice < 3) {
    o.activeTimeRanges = buildUnnamed937();
    o.annotatedAssetId = "foo";
    o.annotatedLocation = "foo";
    o.annotatedUser = "foo";
    o.bootMode = "foo";
    o.deviceFiles = buildUnnamed938();
    o.deviceId = "foo";
    o.etag = "foo";
...
checkChromeOsDevice(api.ChromeOsDevice o) {
  buildCounterChromeOsDevice++;
  if (buildCounterChromeOsDevice < 3) {
    checkUnnamed937(o.activeTimeRanges);
...
checkUnnamed940(core.List<api.ChromeOsDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChromeOsDevices() {
  ...
  if (buildCounterChromeOsDevices < 3) {
    o.chromeosdevices = buildUnnamed940();
    o.etag = "foo";
    o.kind = "foo";
    o.nextPageToken = "foo";
  }
...
checkChromeOsDevices(api.ChromeOsDevices o) {
  buildCounterChromeOsDevices++;
  if (buildCounterChromeOsDevices < 3) {
    checkUnnamed940(o.chromeosdevices);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
...
checkUnnamed942(core.List<api.DomainAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDomainAliases() {
  ...
  if (buildCounterDomainAliases < 3) {
    o.domainAliases = buildUnnamed942();
    o.etag = "foo";
    o.kind = "foo";
  }
  buildCounterDomainAliases--;
...
checkDomainAliases(api.DomainAliases o) {
  buildCounterDomainAliases++;
  if (buildCounterDomainAliases < 3) {
    checkUnnamed942(o.domainAliases);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
  }
  buildCounterDomainAliases--;
...
checkUnnamed943(core.List<api.DomainAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDomainAlias(o[0]);
  checkDomainAlias(o[1]);
}
...
buildDomains() {
  ...
  if (buildCounterDomains < 3) {
    o.creationTime = "foo";
    o.domainAliases = buildUnnamed943();
    o.domainName = "foo";
    o.etag = "foo";
    o.isPrimary = true;
    o.kind = "foo";
...
checkDomains(api.Domains o) {
  ...
  if (buildCounterDomains < 3) {
    unittest.expect(o.creationTime, unittest.equals('foo'));
    checkUnnamed943(o.domainAliases);
...
checkUnnamed944(core.List<api.Domains> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDomains(o[0]);
  checkDomains(o[1]);
}
...
checkUnnamed945(core.List<api.Feature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeature(o[0]);
  checkFeature(o[1]);
}
...
buildMobileDevice() {
  ...
  if (buildCounterMobileDevice < 3) {
    ...
    o.os = "foo";
    o.otherAccountsInfo = buildUnnamed954();
    o.privilege = "foo";
...
checkMobileDevice(api.MobileDevice o) {
  ...
  if (buildCounterMobileDevice < 3) {
    ...
    checkUnnamed954(o.otherAccountsInfo);
...
checkUnnamed955(core.List<api.MobileDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMobileDevices() {
  ...
  if (buildCounterMobileDevices < 3) {
    o.etag = "foo";
    o.kind = "foo";
    o.mobiledevices = buildUnnamed955();
    o.nextPageToken = "foo";
  }
  buildCounterMobileDevices--;
  return o;
...
checkMobileDevices(api.MobileDevices o) {
  ...
  if (buildCounterMobileDevices < 3) {
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed955(o.mobiledevices);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterMobileDevices--;
}
...
checkUnnamed956(core.List<api.Notification> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed957(core.List<api.OrgUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrgUnit(o[0]);
  checkOrgUnit(o[1]);
}
...
buildOrgUnits() {
  ...
  if (buildCounterOrgUnits < 3) {
    o.etag = "foo";
    o.kind = "foo";
    o.organizationUnits = buildUnnamed957();
  }
  buildCounterOrgUnits--;
  return o;
}
...
checkOrgUnits(api.OrgUnits o) {
  ...
  if (buildCounterOrgUnits < 3) {
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed957(o.organizationUnits);
  }
  buildCounterOrgUnits--;
}
...
checkUnnamed958(core.List<api.Privilege> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrivilege(o[0]);
  checkPrivilege(o[1]);
}
...
buildPrivilege() {
  ...
  if (buildCounterPrivilege < 3) {
    o.childPrivileges = buildUnnamed958();
    o.etag = "foo";
    o.isOuScopable = true;
    o.kind = "foo";
    o.privilegeName = "foo";
...
checkPrivilege(api.Privilege o) {
  buildCounterPrivilege++;
  if (buildCounterPrivilege < 3) {
    checkUnnamed958(o.childPrivileges);
    unittest.expect(o.etag, unittest.equals('foo'));
...
checkUnnamed959(core.List<api.Privilege> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrivilege(o[0]);
  checkPrivilege(o[1]);
}
...
checkUnnamed960(core.List<api.RoleRolePrivileges> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRole() {
  ...
  if (buildCounterRole < 3) {
    ...
    o.roleId = "foo";
    o.roleName = "foo";
    o.rolePrivileges = buildUnnamed960();
  }
  buildCounterRole--;
  return o;
}
...
checkRole(api.Role o) {
  ...
  if (buildCounterRole < 3) {
    ...
    checkUnnamed960(o.rolePrivileges);
  }
  buildCounterRole--;
}
...
checkUnnamed961(core.List<api.RoleAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed962(core.List<api.Role> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRole(o[0]);
  checkRole(o[1]);
}
...
checkUnnamed963(core.List<api.SchemaFieldSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed964(core.List<api.Schema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchema(o[0]);
  checkSchema(o[1]);
}
...
checkUnnamed966(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
checkUnnamed967(core.List<api.TrustedAppId> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed969(core.Map<core.String, api.UserCustomProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUser() {
  ...
  if (buildCounterUser < 3) {
    ...
    o.nonEditableAliases = buildUnnamed970();
    o.notes = {
      'list': [1, 2, 3],
      'bool': true,
      'string': 'foo'
...
checkUser(api.User o) {
  ...
  if (buildCounterUser < 3) {
    ...
    checkUnnamed970(o.nonEditableAliases);
...
checkUnnamed971(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
...
checkUnnamed972(core.List<api.VerificationCode> o) {
  unittest.expect(o, unittest.hasLength(2));
...
main() {
  ...
  unittest.group("resource-OrgunitsResourceApi", () {
    unittest.test("method--delete", () {
      ...
      var arg_customerId = "foo";
      var arg_orgUnitPath = buildUnnamed973();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test("method--get", () {
      ...
      api.OrgunitsResourceApi res = new api.AdminApi(mock).orgunits;
      var arg_customerId = "foo";
      var arg_orgUnitPath = buildUnnamed974();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test("method--patch", () {
      ...
      var arg_request = buildOrgUnit();
      var arg_customerId = "foo";
      var arg_orgUnitPath = buildUnnamed975();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var obj = new api.OrgUnit.fromJson(json);
        checkOrgUnit(obj);
    ...
    unittest.test("method--update", () {
      ...
      var arg_request = buildOrgUnit();
      var arg_customerId = "foo";
      var arg_orgUnitPath = buildUnnamed976();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var obj = new api.OrgUnit.fromJson(json);
        checkOrgUnit(obj);
