...
checkUnnamed887(core.List<api.DirectoryListItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed891(core.Map<core.String, api.JsonSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJsonSchema(o["x"]);
  checkJsonSchema(o["y"]);
}
...
checkUnnamed892(core.List<api.JsonSchemaVariantMap> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildJsonSchema() {
  ...
  if (buildCounterJsonSchema < 3) {
    ...
    o.default_ = "foo";
    o.description = "foo";
    o.enum_ = buildUnnamed889();
    o.enumDescriptions = buildUnnamed890();
    o.format = "foo";
    o.id = "foo";
...
checkJsonSchema(api.JsonSchema o) {
  ...
  if (buildCounterJsonSchema < 3) {
    ...
    unittest.expect(o.description, unittest.equals('foo'));
    checkUnnamed889(o.enum_);
    checkUnnamed890(o.enumDescriptions);
...
checkUnnamed896(core.Map<core.String, api.RestMethod> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRestMethod(o["x"]);
  checkRestMethod(o["y"]);
}
...
checkUnnamed897(core.Map<core.String, api.JsonSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJsonSchema(o["x"]);
  checkJsonSchema(o["y"]);
}
...
checkUnnamed898(core.Map<core.String, api.RestResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed899(core.Map<core.String, api.JsonSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJsonSchema(o["x"]);
  checkJsonSchema(o["y"]);
}
...
buildRestDescription() {
  ...
  if (buildCounterRestDescription < 3) {
    ...
    o.features = buildUnnamed894();
    o.icons = buildRestDescriptionIcons();
    o.id = "foo";
    o.kind = "foo";
    o.labels = buildUnnamed895();
    o.methods = buildUnnamed896();
    o.name = "foo";
    o.ownerDomain = "foo";
    o.ownerName = "foo";
    o.packagePath = "foo";
    o.parameters = buildUnnamed897();
    o.protocol = "foo";
    o.resources = buildUnnamed898();
    o.revision = "foo";
    o.rootUrl = "foo";
    o.schemas = buildUnnamed899();
    o.servicePath = "foo";
    o.title = "foo";
    o.version = "foo";
...
checkRestDescription(api.RestDescription o) {
  ...
  if (buildCounterRestDescription < 3) {
    ...
    checkUnnamed894(o.features);
    checkRestDescriptionIcons(o.icons);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed895(o.labels);
    checkUnnamed896(o.methods);
    unittest.expect(o.name, unittest.equals('foo'));
...
checkUnnamed902(core.Map<core.String, api.JsonSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJsonSchema(o["x"]);
  checkJsonSchema(o["y"]);
}
...
buildRestMethod() {
  ...
  if (buildCounterRestMethod < 3) {
    ...
    o.parameterOrder = buildUnnamed901();
    o.parameters = buildUnnamed902();
    o.path = "foo";
...
checkRestMethod(api.RestMethod o) {
  ...
  if (buildCounterRestMethod < 3) {
    ...
    checkUnnamed901(o.parameterOrder);
    checkUnnamed902(o.parameters);
    unittest.expect(o.path, unittest.equals('foo'));
...
checkUnnamed904(core.Map<core.String, api.RestMethod> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRestMethod(o["x"]);
  checkRestMethod(o["y"]);
}
...
checkUnnamed905(core.Map<core.String, api.RestResource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRestResource(o["x"]);
  checkRestResource(o["y"]);
}
