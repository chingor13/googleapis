...
checkUnnamed3452(core.List<api.PlusAclentryResource> o) {
...
checkUnnamed3453(core.List<api.ActivityObjectAttachmentsThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3454(core.List<api.ActivityObjectAttachments> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityObject() {
  ...
  if (buildCounterActivityObject < 3) {
    ...
    o.attachments = buildUnnamed3454();
    o.content = "foo";
    o.id = "foo";
    o.objectType = "foo";
...
checkActivityObject(api.ActivityObject o) {
  ...
  if (buildCounterActivityObject < 3) {
    ...
    checkUnnamed3454(o.attachments);
    unittest.expect(o.content, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.objectType, unittest.equals('foo'));
...
checkUnnamed3455(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed3456(core.List<api.CommentInReplyTo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3457(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed3458(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
checkUnnamed3459(core.List<api.PersonEmails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3460(core.List<api.PersonOrganizations> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3461(core.List<api.PersonPlacesLived> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3462(core.List<api.PersonUrls> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPersonUrls(o[0]);
  checkPersonUrls(o[1]);
}
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    ...
    o.objectType = "foo";
    o.occupation = "foo";
    o.organizations = buildUnnamed3460();
    o.placesLived = buildUnnamed3461();
    o.plusOneCount = 42;
    o.relationshipStatus = "foo";
    o.skills = "foo";
    o.tagline = "foo";
    o.url = "foo";
    o.urls = buildUnnamed3462();
    o.verified = true;
  }
  buildCounterPerson--;
  return o;
...
checkPerson(api.Person o) {
  ...
  if (buildCounterPerson < 3) {
    ...
    checkUnnamed3460(o.organizations);
    checkUnnamed3461(o.placesLived);
