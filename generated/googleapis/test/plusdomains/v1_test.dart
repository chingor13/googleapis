...
checkUnnamed2604(core.List<api.PlusDomainsAclentryResource> o) {
...
checkUnnamed2605(core.List<api.ActivityObjectAttachmentsPreviewThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2606(core.List<api.ActivityObjectAttachmentsThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityObjectAttachments() {
  ...
  if (buildCounterActivityObjectAttachments < 3) {
    ...
    o.objectType = "foo";
    o.previewThumbnails = buildUnnamed2605();
    o.thumbnails = buildUnnamed2606();
    o.url = "foo";
  }
  buildCounterActivityObjectAttachments--;
  return o;
...
checkActivityObjectAttachments(api.ActivityObjectAttachments o) {
  ...
  if (buildCounterActivityObjectAttachments < 3) {
    ...
    checkUnnamed2605(o.previewThumbnails);
    checkUnnamed2606(o.thumbnails);
    unittest.expect(o.url, unittest.equals('foo'));
  }
  buildCounterActivityObjectAttachments--;
}
...
checkUnnamed2607(core.List<api.ActivityObjectAttachments> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityObject() {
  ...
  if (buildCounterActivityObject < 3) {
    ...
    o.attachments = buildUnnamed2607();
    o.content = "foo";
    o.id = "foo";
    o.objectType = "foo";
...
checkActivityObject(api.ActivityObject o) {
  ...
  if (buildCounterActivityObject < 3) {
    ...
    checkUnnamed2607(o.attachments);
    unittest.expect(o.content, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.objectType, unittest.equals('foo'));
...
checkUnnamed2608(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed2609(core.List<api.Audience> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAudience(o[0]);
  checkAudience(o[1]);
}
...
checkUnnamed2610(core.List<api.Circle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCircle(o[0]);
  checkCircle(o[1]);
}
...
checkUnnamed2611(core.List<api.CommentInReplyTo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2612(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed2613(core.List<api.Videostream> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2614(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
checkUnnamed2615(core.List<api.PersonEmails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2616(core.List<api.PersonOrganizations> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2617(core.List<api.PersonPlacesLived> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2618(core.List<api.PersonUrls> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPersonUrls(o[0]);
  checkPersonUrls(o[1]);
}
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    ...
    o.objectType = "foo";
    o.occupation = "foo";
    o.organizations = buildUnnamed2616();
    o.placesLived = buildUnnamed2617();
    o.plusOneCount = 42;
    o.relationshipStatus = "foo";
    o.skills = "foo";
    o.tagline = "foo";
    o.url = "foo";
    o.urls = buildUnnamed2618();
    o.verified = true;
  }
  buildCounterPerson--;
  return o;
...
checkPerson(api.Person o) {
  ...
  if (buildCounterPerson < 3) {
    ...
    checkUnnamed2616(o.organizations);
    checkUnnamed2617(o.placesLived);
...
main() {
  ...
  unittest.group("resource-CirclesResourceApi", () {
    unittest.test("method--addPeople", () {
      ...
      var arg_email = buildUnnamed2619();
      var arg_userId = buildUnnamed2620();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test("method--removePeople", () {
      ...
      api.CirclesResourceApi res = new api.PlusDomainsApi(mock).circles;
      var arg_circleId = "foo";
      var arg_email = buildUnnamed2621();
      var arg_userId = buildUnnamed2622();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
