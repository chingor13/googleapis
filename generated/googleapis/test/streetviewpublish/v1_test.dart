...
checkUnnamed2116(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}
...
checkUnnamed2117(core.List<api.PhotoResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2118(core.List<api.UpdatePhotoRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBatchUpdatePhotosRequest() {
  ...
  if (buildCounterBatchUpdatePhotosRequest < 3) {
    o.updatePhotoRequests = buildUnnamed2118();
  }
  buildCounterBatchUpdatePhotosRequest--;
  return o;
}
...
checkBatchUpdatePhotosRequest(api.BatchUpdatePhotosRequest o) {
  buildCounterBatchUpdatePhotosRequest++;
  if (buildCounterBatchUpdatePhotosRequest < 3) {
    checkUnnamed2118(o.updatePhotoRequests);
  }
  buildCounterBatchUpdatePhotosRequest--;
}
...
checkUnnamed2119(core.List<api.PhotoResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhotoResponse(o[0]);
  checkPhotoResponse(o[1]);
}
...
checkUnnamed2120(core.List<api.Photo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhoto(o[0]);
  checkPhoto(o[1]);
}
...
checkUnnamed2123(core.List<api.Connection> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConnection(o[0]);
  checkConnection(o[1]);
}
...
checkUnnamed2124(core.List<api.Place> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlace(o[0]);
  checkPlace(o[1]);
}
...
buildPhoto() {
  ...
  if (buildCounterPhoto < 3) {
    o.captureTime = "foo";
    o.connections = buildUnnamed2123();
    o.downloadUrl = "foo";
    o.photoId = buildPhotoId();
    o.places = buildUnnamed2124();
    o.pose = buildPose();
    o.shareLink = "foo";
    o.thumbnailUrl = "foo";
...
checkPhoto(api.Photo o) {
  ...
  if (buildCounterPhoto < 3) {
    ...
    checkUnnamed2123(o.connections);
    unittest.expect(o.downloadUrl, unittest.equals('foo'));
    checkPhotoId(o.photoId);
    checkUnnamed2124(o.places);
    checkPose(o.pose);
...
checkUnnamed2126(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
main() {
  ...
  unittest.group("resource-PhotosResourceApi", () {
    ...
    unittest.test("method--batchGet", () {
      ...
      api.PhotosResourceApi res = new api.StreetviewpublishApi(mock).photos;
      var arg_view = "foo";
      var arg_photoIds = buildUnnamed2127();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
