...
checkUnnamed477(core.List<api.Request> o) {
...
checkUnnamed478(core.List<api.Response> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResponse(o[0]);
  checkResponse(o[1]);
}
...
checkUnnamed479(core.List<api.ThemeColorPair> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed480(core.List<api.LayoutPlaceholderIdMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCreateSlideRequest() {
  ...
  if (buildCounterCreateSlideRequest < 3) {
    o.insertionIndex = 42;
    o.objectId = "foo";
    o.placeholderIdMappings = buildUnnamed480();
...
checkCreateSlideRequest(api.CreateSlideRequest o) {
  ...
  if (buildCounterCreateSlideRequest < 3) {
    ...
    unittest.expect(o.objectId, unittest.equals('foo'));
    checkUnnamed480(o.placeholderIdMappings);
...
checkUnnamed482(core.List<api.PageElement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGroupObjectsRequest() {
  ...
  if (buildCounterGroupObjectsRequest < 3) {
    o.childrenObjectIds = buildUnnamed483();
    o.groupObjectId = "foo";
  }
  buildCounterGroupObjectsRequest--;
  return o;
...
checkGroupObjectsRequest(api.GroupObjectsRequest o) {
  buildCounterGroupObjectsRequest++;
  if (buildCounterGroupObjectsRequest < 3) {
    checkUnnamed483(o.childrenObjectIds);
...
checkUnnamed484(core.Map<core.String, api.NestingLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildList() {
  ...
  if (buildCounterList < 3) {
    o.listId = "foo";
    o.nestingLevel = buildUnnamed484();
  }
  buildCounterList--;
  return o;
}
...
checkList(api.List o) {
  ...
  if (buildCounterList < 3) {
    unittest.expect(o.listId, unittest.equals('foo'));
    checkUnnamed484(o.nestingLevel);
  }
  buildCounterList--;
}
...
checkUnnamed485(core.List<api.PageElement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPageElement(o[0]);
  checkPageElement(o[1]);
}
...
buildPage() {
  ...
  if (buildCounterPage < 3) {
    ...
    o.objectId = "foo";
    o.pageElements = buildUnnamed485();
...
checkPage(api.Page o) {
  ...
  if (buildCounterPage < 3) {
    ...
    unittest.expect(o.objectId, unittest.equals('foo'));
    checkUnnamed485(o.pageElements);
...
checkUnnamed486(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed487(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed488(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
buildPresentation() {
  ...
  if (buildCounterPresentation < 3) {
    o.layouts = buildUnnamed486();
    o.locale = "foo";
    o.masters = buildUnnamed487();
    o.notesMaster = buildPage();
    o.pageSize = buildSize();
    o.presentationId = "foo";
    o.revisionId = "foo";
    o.slides = buildUnnamed488();
    o.title = "foo";
  }
  buildCounterPresentation--;
  return o;
...
checkPresentation(api.Presentation o) {
  buildCounterPresentation++;
  if (buildCounterPresentation < 3) {
    checkUnnamed486(o.layouts);
    unittest.expect(o.locale, unittest.equals('foo'));
    checkUnnamed487(o.masters);
    checkPage(o.notesMaster);
    checkSize(o.pageSize);
    unittest.expect(o.presentationId, unittest.equals('foo'));
    unittest.expect(o.revisionId, unittest.equals('foo'));
    checkUnnamed488(o.slides);
    unittest.expect(o.title, unittest.equals('foo'));
  }
  buildCounterPresentation--;
}
...
checkUnnamed489(core.List<api.ColorStop> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColorStop(o[0]);
  checkColorStop(o[1]);
}
...
buildRecolor() {
  ...
  if (buildCounterRecolor < 3) {
    o.name = "foo";
    o.recolorStops = buildUnnamed489();
  }
  buildCounterRecolor--;
  return o;
}
...
checkRecolor(api.Recolor o) {
  ...
  if (buildCounterRecolor < 3) {
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed489(o.recolorStops);
  }
  buildCounterRecolor--;
}
...
buildReplaceAllShapesWithImageRequest() {
  ...
  if (buildCounterReplaceAllShapesWithImageRequest < 3) {
    ...
    o.imageUrl = "foo";
    o.pageObjectIds = buildUnnamed490();
    o.replaceMethod = "foo";
  }
  buildCounterReplaceAllShapesWithImageRequest--;
  return o;
...
checkReplaceAllShapesWithImageRequest(api.ReplaceAllShapesWithImageRequest o) {
  ...
  if (buildCounterReplaceAllShapesWithImageRequest < 3) {
    ...
    checkUnnamed490(o.pageObjectIds);
...
buildReplaceAllShapesWithSheetsChartRequest() {
  ...
  if (buildCounterReplaceAllShapesWithSheetsChartRequest < 3) {
    ...
    o.containsText = buildSubstringMatchCriteria();
    o.linkingMode = "foo";
    o.pageObjectIds = buildUnnamed491();
    o.spreadsheetId = "foo";
  }
  buildCounterReplaceAllShapesWithSheetsChartRequest--;
  return o;
...
checkReplaceAllShapesWithSheetsChartRequest(
  ...
  if (buildCounterReplaceAllShapesWithSheetsChartRequest < 3) {
    ...
    checkSubstringMatchCriteria(o.containsText);
    unittest.expect(o.linkingMode, unittest.equals('foo'));
    checkUnnamed491(o.pageObjectIds);
    unittest.expect(o.spreadsheetId, unittest.equals('foo'));
  }
  buildCounterReplaceAllShapesWithSheetsChartRequest--;
}
...
buildReplaceAllTextRequest() {
  ...
  if (buildCounterReplaceAllTextRequest < 3) {
    o.containsText = buildSubstringMatchCriteria();
    o.pageObjectIds = buildUnnamed492();
    o.replaceText = "foo";
  }
  buildCounterReplaceAllTextRequest--;
  return o;
...
checkReplaceAllTextRequest(api.ReplaceAllTextRequest o) {
  ...
  if (buildCounterReplaceAllTextRequest < 3) {
    checkSubstringMatchCriteria(o.containsText);
    checkUnnamed492(o.pageObjectIds);
...
checkUnnamed493(core.List<api.TableBorderRow> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed494(core.List<api.TableColumnProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed496(core.List<api.TableBorderRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTableBorderRow(o[0]);
  checkTableBorderRow(o[1]);
}
...
buildTable() {
  ...
  if (buildCounterTable < 3) {
    o.columns = 42;
    o.horizontalBorderRows = buildUnnamed493();
    o.rows = 42;
    o.tableColumns = buildUnnamed494();
    o.tableRows = buildUnnamed495();
    o.verticalBorderRows = buildUnnamed496();
  }
  buildCounterTable--;
  return o;
}
...
checkTable(api.Table o) {
  ...
  if (buildCounterTable < 3) {
    unittest.expect(o.columns, unittest.equals(42));
    checkUnnamed493(o.horizontalBorderRows);
    unittest.expect(o.rows, unittest.equals(42));
    checkUnnamed494(o.tableColumns);
    checkUnnamed495(o.tableRows);
    checkUnnamed496(o.verticalBorderRows);
  }
  buildCounterTable--;
}
...
checkUnnamed497(core.List<api.TableBorderCell> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTableBorderRow() {
  ...
  if (buildCounterTableBorderRow < 3) {
    o.tableBorderCells = buildUnnamed497();
  }
  buildCounterTableBorderRow--;
  return o;
}
...
checkTableBorderRow(api.TableBorderRow o) {
  buildCounterTableBorderRow++;
  if (buildCounterTableBorderRow < 3) {
    checkUnnamed497(o.tableBorderCells);
  }
  buildCounterTableBorderRow--;
}
...
checkUnnamed499(core.Map<core.String, api.List> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkList(o["x"]);
  checkList(o["y"]);
}
...
checkUnnamed500(core.List<api.TextElement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTextContent() {
  ...
  if (buildCounterTextContent < 3) {
    o.lists = buildUnnamed499();
    o.textElements = buildUnnamed500();
  }
  buildCounterTextContent--;
  return o;
}
...
checkTextContent(api.TextContent o) {
  buildCounterTextContent++;
  if (buildCounterTextContent < 3) {
    checkUnnamed499(o.lists);
    checkUnnamed500(o.textElements);
  }
  buildCounterTextContent--;
}
...
buildUpdateSlidesPositionRequest() {
  ...
  if (buildCounterUpdateSlidesPositionRequest < 3) {
    o.insertionIndex = 42;
    o.slideObjectIds = buildUnnamed502();
  }
  buildCounterUpdateSlidesPositionRequest--;
  return o;
}
...
checkUpdateSlidesPositionRequest(api.UpdateSlidesPositionRequest o) {
  ...
  if (buildCounterUpdateSlidesPositionRequest < 3) {
    unittest.expect(o.insertionIndex, unittest.equals(42));
    checkUnnamed502(o.slideObjectIds);
  }
  buildCounterUpdateSlidesPositionRequest--;
}
...
checkUnnamed503(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUpdateTableColumnPropertiesRequest() {
  ...
  if (buildCounterUpdateTableColumnPropertiesRequest < 3) {
    o.columnIndices = buildUnnamed503();
    o.fields = "foo";
    o.objectId = "foo";
...
checkUpdateTableColumnPropertiesRequest(
  ...
  buildCounterUpdateTableColumnPropertiesRequest++;
  if (buildCounterUpdateTableColumnPropertiesRequest < 3) {
    checkUnnamed503(o.columnIndices);
    unittest.expect(o.fields, unittest.equals('foo'));
    unittest.expect(o.objectId, unittest.equals('foo'));
...
checkUnnamed504(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
