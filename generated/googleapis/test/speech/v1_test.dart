...
checkUnnamed391(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed390();
    o.name = "foo";
    o.response = buildUnnamed391();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed390(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed391(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed392(core.List<api.SpeechContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRecognitionConfig() {
  ...
  if (buildCounterRecognitionConfig < 3) {
    ...
    o.speechContexts = buildUnnamed392();
  }
  buildCounterRecognitionConfig--;
  return o;
}
...
checkRecognitionConfig(api.RecognitionConfig o) {
  ...
  if (buildCounterRecognitionConfig < 3) {
    ...
    checkUnnamed392(o.speechContexts);
  }
  buildCounterRecognitionConfig--;
}
...
checkUnnamed393(core.List<api.SpeechRecognitionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed395(core.List<api.WordInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWordInfo(o[0]);
  checkWordInfo(o[1]);
}
...
checkUnnamed396(core.List<api.SpeechRecognitionAlternative> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSpeechRecognitionResult() {
  ...
  if (buildCounterSpeechRecognitionResult < 3) {
    o.alternatives = buildUnnamed396();
  }
  buildCounterSpeechRecognitionResult--;
  return o;
}
...
checkSpeechRecognitionResult(api.SpeechRecognitionResult o) {
  buildCounterSpeechRecognitionResult++;
  if (buildCounterSpeechRecognitionResult < 3) {
    checkUnnamed396(o.alternatives);
  }
  buildCounterSpeechRecognitionResult--;
}
