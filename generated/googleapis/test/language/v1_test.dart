...
checkUnnamed1541(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}
...
checkUnnamed1542(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed1543(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed1544(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
buildAnalyzeSyntaxResponse() {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    o.language = "foo";
    o.sentences = buildUnnamed1543();
    o.tokens = buildUnnamed1544();
  }
  buildCounterAnalyzeSyntaxResponse--;
  return o;
}
...
checkAnalyzeSyntaxResponse(api.AnalyzeSyntaxResponse o) {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    unittest.expect(o.language, unittest.equals('foo'));
    checkUnnamed1543(o.sentences);
    checkUnnamed1544(o.tokens);
  }
  buildCounterAnalyzeSyntaxResponse--;
}
...
checkUnnamed1545(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1546(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}
...
checkUnnamed1547(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed1548(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
buildAnnotateTextResponse() {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    o.categories = buildUnnamed1545();
    o.documentSentiment = buildSentiment();
    o.entities = buildUnnamed1546();
    o.language = "foo";
    o.sentences = buildUnnamed1547();
    o.tokens = buildUnnamed1548();
  }
  buildCounterAnnotateTextResponse--;
  return o;
}
...
checkAnnotateTextResponse(api.AnnotateTextResponse o) {
  buildCounterAnnotateTextResponse++;
  if (buildCounterAnnotateTextResponse < 3) {
    checkUnnamed1545(o.categories);
    checkSentiment(o.documentSentiment);
    checkUnnamed1546(o.entities);
    unittest.expect(o.language, unittest.equals('foo'));
    checkUnnamed1547(o.sentences);
    checkUnnamed1548(o.tokens);
  }
  buildCounterAnnotateTextResponse--;
}
...
checkUnnamed1549(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClassificationCategory(o[0]);
  checkClassificationCategory(o[1]);
}
...
checkUnnamed1550(core.List<api.EntityMention> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1551(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildEntity() {
  ...
  if (buildCounterEntity < 3) {
    o.mentions = buildUnnamed1550();
    o.metadata = buildUnnamed1551();
    o.name = "foo";
    o.salience = 42.0;
...
checkEntity(api.Entity o) {
  buildCounterEntity++;
  if (buildCounterEntity < 3) {
    checkUnnamed1550(o.mentions);
    checkUnnamed1551(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
...
checkUnnamed1552(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1553() {
  ...
  o.add(buildUnnamed1552());
  o.add(buildUnnamed1552());
  return o;
}

checkUnnamed1553(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1552(o[0]);
  checkUnnamed1552(o[1]);
}
