...
checkUnnamed2906(core.List<api.DynamicLinkWarning> o) {
...
checkUnnamed2907(core.List<api.DynamicLinkWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDynamicLinkWarning(o[0]);
  checkDynamicLinkWarning(o[1]);
}
...
checkUnnamed2908(core.List<api.DynamicLinkEventStat> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDynamicLinkStats() {
  ...
  if (buildCounterDynamicLinkStats < 3) {
    o.linkEventStats = buildUnnamed2908();
  }
  buildCounterDynamicLinkStats--;
  return o;
}
...
checkDynamicLinkStats(api.DynamicLinkStats o) {
  buildCounterDynamicLinkStats++;
  if (buildCounterDynamicLinkStats < 3) {
    checkUnnamed2908(o.linkEventStats);
  }
  buildCounterDynamicLinkStats--;
}
...
buildManagedShortLink() {
  ...
  if (buildCounterManagedShortLink < 3) {
    o.creationTime = "foo";
    o.flaggedAttribute = buildUnnamed2909();
...
checkManagedShortLink(api.ManagedShortLink o) {
  ...
  if (buildCounterManagedShortLink < 3) {
    ...
    checkUnnamed2909(o.flaggedAttribute);
