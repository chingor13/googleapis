...
checkUnnamed2753(core.List<api.CustomDimension> o) {
...
checkUnnamed2754(core.List<api.CustomMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildConversion() {
  ...
  if (buildCounterConversion < 3) {
    ...
    o.criterionId = "foo";
    o.currencyCode = "foo";
    o.customDimension = buildUnnamed2753();
    o.customMetric = buildUnnamed2754();
    o.deviceType = "foo";
...
checkConversion(api.Conversion o) {
  ...
  if (buildCounterConversion < 3) {
    ...
    checkUnnamed2753(o.customDimension);
    checkUnnamed2754(o.customMetric);
...
checkUnnamed2755(core.List<api.Conversion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConversion(o[0]);
  checkConversion(o[1]);
}
...
checkUnnamed2756(core.List<api.ReportFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2757(core.List<api.ReportRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportRow(o[0]);
  checkReportRow(o[1]);
}
...
checkUnnamed2758(core.List<api.ReportApiColumnSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2759(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2760(core.List<api.ReportRequestFilters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2761(core.List<api.ReportRequestOrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2762(core.List<api.SavedColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2763(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUpdateAvailabilityRequest() {
  ...
  if (buildCounterUpdateAvailabilityRequest < 3) {
    o.availabilities = buildUnnamed2763();
  }
  buildCounterUpdateAvailabilityRequest--;
  return o;
}
...
checkUpdateAvailabilityRequest(api.UpdateAvailabilityRequest o) {
  buildCounterUpdateAvailabilityRequest++;
  if (buildCounterUpdateAvailabilityRequest < 3) {
    checkUnnamed2763(o.availabilities);
  }
  buildCounterUpdateAvailabilityRequest--;
}
...
checkUnnamed2764(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAvailability(o[0]);
  checkAvailability(o[1]);
}
...
buildUpdateAvailabilityResponse() {
  ...
  if (buildCounterUpdateAvailabilityResponse < 3) {
    o.availabilities = buildUnnamed2764();
  }
  buildCounterUpdateAvailabilityResponse--;
  return o;
}
...
checkUpdateAvailabilityResponse(api.UpdateAvailabilityResponse o) {
  buildCounterUpdateAvailabilityResponse++;
  if (buildCounterUpdateAvailabilityResponse < 3) {
    checkUnnamed2764(o.availabilities);
  }
  buildCounterUpdateAvailabilityResponse--;
}
