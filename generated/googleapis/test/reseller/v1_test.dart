...
buildResellernotifyGetwatchdetailsResponse() {
  ...
  if (buildCounterResellernotifyGetwatchdetailsResponse < 3) {
    o.serviceAccountEmailAddresses = buildUnnamed977();
    o.topicName = "foo";
  }
  buildCounterResellernotifyGetwatchdetailsResponse--;
  return o;
...
checkResellernotifyGetwatchdetailsResponse(
  ...
  buildCounterResellernotifyGetwatchdetailsResponse++;
  if (buildCounterResellernotifyGetwatchdetailsResponse < 3) {
    checkUnnamed977(o.serviceAccountEmailAddresses);
...
buildSubscription() {
  ...
  if (buildCounterSubscription < 3) {
    ...
    o.suspensionReasons = buildUnnamed978();
...
checkSubscription(api.Subscription o) {
  ...
  if (buildCounterSubscription < 3) {
    ...
    checkUnnamed978(o.suspensionReasons);
...
checkUnnamed979(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSubscriptions() {
  ...
  if (buildCounterSubscriptions < 3) {
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed979();
  }
  buildCounterSubscriptions--;
  return o;
}
...
checkSubscriptions(api.Subscriptions o) {
  ...
  if (buildCounterSubscriptions < 3) {
    ...
    checkUnnamed979(o.subscriptions);
  }
  buildCounterSubscriptions--;
}
