...
checkUnnamed1361(core.List<api.DetectionsResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1362(core.List<api.LanguagesResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1364(core.List<api.TranslationsResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTranslationsListResponse() {
  ...
  if (buildCounterTranslationsListResponse < 3) {
    o.translations = buildUnnamed1364();
  }
  buildCounterTranslationsListResponse--;
  return o;
}
...
checkTranslationsListResponse(api.TranslationsListResponse o) {
  buildCounterTranslationsListResponse++;
  if (buildCounterTranslationsListResponse < 3) {
    checkUnnamed1364(o.translations);
  }
  buildCounterTranslationsListResponse--;
}
...
main() {
  ...
  unittest.group("resource-TranslationsResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_q = buildUnnamed1366();
      var arg_target = "foo";
      var arg_source = "foo";
      var arg_cid = buildUnnamed1367();
      var arg_format = "foo";
      var arg_model = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
