...
checkUnnamed1386(core.List<api.AdClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdClient(o[0]);
  checkAdClient(o[1]);
}
...
checkUnnamed1387(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed1388(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1389(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1390(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1392(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1394(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed1391();
    o.headers = buildUnnamed1392();
    o.kind = "foo";
    o.rows = buildUnnamed1394();
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed1395();
    o.warnings = buildUnnamed1396();
  }
  buildCounterReport--;
  return o;
}
...
checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed1391(o.averages);
    checkUnnamed1392(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1394(o.rows);
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed1395(o.totals);
    checkUnnamed1396(o.warnings);
  }
  buildCounterReport--;
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed1397();
    o.compatibleMetrics = buildUnnamed1398();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed1399();
    o.requiredMetrics = buildUnnamed1400();
    o.supportedProducts = buildUnnamed1401();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed1397(o.compatibleDimensions);
    checkUnnamed1398(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1399(o.requiredDimensions);
    checkUnnamed1400(o.requiredMetrics);
    checkUnnamed1401(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed1402(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1403(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
main() {
  ...
  unittest.group("resource-AccountsReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_endDate = "foo";
      var arg_dimension = buildUnnamed1404();
      var arg_filter = buildUnnamed1405();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed1406();
      var arg_sort = buildUnnamed1407();
