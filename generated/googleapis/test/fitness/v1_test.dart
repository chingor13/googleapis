...
checkUnnamed906(core.List<api.Dataset> o) {
...
checkUnnamed907(core.List<api.AggregateBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAggregateRequest() {
  ...
  if (buildCounterAggregateRequest < 3) {
    ...
    o.endTimeMillis = "foo";
    o.filteredDataQualityStandard = buildUnnamed908();
    o.startTimeMillis = "foo";
  }
  buildCounterAggregateRequest--;
  return o;
...
checkAggregateRequest(api.AggregateRequest o) {
  ...
  if (buildCounterAggregateRequest < 3) {
    ...
    unittest.expect(o.endTimeMillis, unittest.equals('foo'));
    checkUnnamed908(o.filteredDataQualityStandard);
    unittest.expect(o.startTimeMillis, unittest.equals('foo'));
  }
  buildCounterAggregateRequest--;
}
...
checkUnnamed909(core.List<api.AggregateBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed910(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
buildDataSource() {
  ...
  if (buildCounterDataSource < 3) {
    ...
    o.dataQualityStandard = buildUnnamed911();
    o.dataStreamId = "foo";
...
checkDataSource(api.DataSource o) {
  ...
  if (buildCounterDataSource < 3) {
    ...
    checkUnnamed911(o.dataQualityStandard);
...
checkUnnamed912(core.List<api.DataTypeField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed913(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
checkUnnamed914(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
checkUnnamed915(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
buildListDataPointChangesResponse() {
  ...
  if (buildCounterListDataPointChangesResponse < 3) {
    o.dataSourceId = "foo";
    o.deletedDataPoint = buildUnnamed914();
    o.insertedDataPoint = buildUnnamed915();
    o.nextPageToken = "foo";
  }
  buildCounterListDataPointChangesResponse--;
  return o;
...
checkListDataPointChangesResponse(api.ListDataPointChangesResponse o) {
  ...
  if (buildCounterListDataPointChangesResponse < 3) {
    unittest.expect(o.dataSourceId, unittest.equals('foo'));
    checkUnnamed914(o.deletedDataPoint);
    checkUnnamed915(o.insertedDataPoint);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListDataPointChangesResponse--;
}
...
checkUnnamed916(core.List<api.DataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSource(o[0]);
  checkDataSource(o[1]);
}
...
checkUnnamed917(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
checkUnnamed918(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
buildListSessionsResponse() {
  ...
  if (buildCounterListSessionsResponse < 3) {
    o.deletedSession = buildUnnamed917();
    o.hasMoreData = true;
    o.nextPageToken = "foo";
    o.session = buildUnnamed918();
  }
  buildCounterListSessionsResponse--;
  return o;
}
...
checkListSessionsResponse(api.ListSessionsResponse o) {
  buildCounterListSessionsResponse++;
  if (buildCounterListSessionsResponse < 3) {
    checkUnnamed917(o.deletedSession);
    unittest.expect(o.hasMoreData, unittest.isTrue);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed918(o.session);
  }
  buildCounterListSessionsResponse--;
}
...
checkUnnamed919(core.List<api.ValueMapValEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  ...
  unittest.group("resource-UsersDataSourcesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      api.UsersDataSourcesResourceApi res =
          new api.FitnessApi(mock).users.dataSources;
      var arg_userId = "foo";
      var arg_dataTypeName = buildUnnamed920();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
