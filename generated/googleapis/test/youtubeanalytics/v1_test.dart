...
checkUnnamed1472(core.List<api.GroupItem> o) {
...
checkUnnamed1473(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
checkUnnamed1474(core.List<api.ResultTableColumnHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1476() {
  ...
  o.add(buildUnnamed1475());
  o.add(buildUnnamed1475());
  return o;
}

checkUnnamed1476(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1475(o[0]);
  checkUnnamed1475(o[1]);
}
...
buildResultTable() {
  ...
  if (buildCounterResultTable < 3) {
    o.columnHeaders = buildUnnamed1474();
    o.kind = "foo";
    o.rows = buildUnnamed1476();
  }
  buildCounterResultTable--;
  return o;
}
...
checkResultTable(api.ResultTable o) {
  buildCounterResultTable++;
  if (buildCounterResultTable < 3) {
    checkUnnamed1474(o.columnHeaders);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1476(o.rows);
  }
  buildCounterResultTable--;
}
