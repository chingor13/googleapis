...
checkUnnamed994(core.List<api.FieldMask> o) {
...
checkUnnamed995(core.List<api.FieldMask> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFieldMask(o[0]);
  checkFieldMask(o[1]);
}
...
checkUnnamed997(core.List<api.SurveyQuestion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSurvey() {
  ...
  if (buildCounterSurvey < 3) {
    ...
    o.customerData = "foo";
    o.description = "foo";
    o.owners = buildUnnamed996();
    o.questions = buildUnnamed997();
...
checkSurvey(api.Survey o) {
  ...
  if (buildCounterSurvey < 3) {
    ...
    checkUnnamed996(o.owners);
    checkUnnamed997(o.questions);
...
buildSurveyAudience() {
  ...
  if (buildCounterSurveyAudience < 3) {
    o.ages = buildUnnamed998();
    o.country = "foo";
    o.countrySubdivision = "foo";
    o.gender = "foo";
    o.languages = buildUnnamed999();
...
checkUnnamed1001(core.List<api.SurveyQuestionImage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkSurveyQuestion(api.SurveyQuestion o) {
  ...
  if (buildCounterSurveyQuestion < 3) {
    ...
    checkUnnamed1002(o.openTextSuggestions);
    ...
    checkUnnamed1003(o.thresholdAnswers);
...
checkUnnamed1004(core.List<api.Survey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSurvey(o[0]);
  checkSurvey(o[1]);
}
