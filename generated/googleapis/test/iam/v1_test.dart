...
checkUnnamed281(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed281();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed281(o.auditLogConfigs);
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed282();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed282(o.exemptedMembers);
...
checkUnnamed284(core.List<api.Role> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRole(o[0]);
  checkRole(o[1]);
}
...
checkUnnamed285(core.List<api.ServiceAccountKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed286(core.List<api.ServiceAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed287(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed288(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed287();
    o.bindings = buildUnnamed288();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed287(o.auditConfigs);
    checkUnnamed288(o.bindings);
...
checkUnnamed289(core.List<api.BindingDelta> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPolicyDelta() {
  ...
  if (buildCounterPolicyDelta < 3) {
    o.bindingDeltas = buildUnnamed289();
  }
  buildCounterPolicyDelta--;
  return o;
}
...
checkPolicyDelta(api.PolicyDelta o) {
  buildCounterPolicyDelta++;
  if (buildCounterPolicyDelta < 3) {
    checkUnnamed289(o.bindingDeltas);
  }
  buildCounterPolicyDelta--;
}
...
checkUnnamed290(core.List<api.AuditableService> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed291(core.List<api.Role> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRole(o[0]);
  checkRole(o[1]);
}
...
checkUnnamed292(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
buildRole() {
  ...
  if (buildCounterRole < 3) {
    ...
    o.description = "foo";
    o.etag = "foo";
    o.includedPermissions = buildUnnamed293();
    o.name = "foo";
    o.stage = "foo";
    o.title = "foo";
  }
...
checkRole(api.Role o) {
  ...
  if (buildCounterRole < 3) {
    ...
    unittest.expect(o.description, unittest.equals('foo'));
    unittest.expect(o.etag, unittest.equals('foo'));
    checkUnnamed293(o.includedPermissions);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.stage, unittest.equals('foo'));
    unittest.expect(o.title, unittest.equals('foo'));
  }
  ...
  unittest.group("resource-ProjectsServiceAccountsKeysResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      api.ProjectsServiceAccountsKeysResourceApi res =
          new api.IamApi(mock).projects.serviceAccounts.keys;
      var arg_name = "foo";
      var arg_keyTypes = buildUnnamed296();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
