...
checkUnnamed1554(core.List<api.Event> o) {
...
buildActivity() {
  ...
  if (buildCounterActivity < 3) {
    ...
    o.singleEvents = buildUnnamed1554();
  }
  buildCounterActivity--;
  return o;
}
...
checkActivity(api.Activity o) {
  ...
  if (buildCounterActivity < 3) {
    ...
    checkUnnamed1554(o.singleEvents);
  }
  buildCounterActivity--;
}
...
checkUnnamed1556(core.List<api.PermissionChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildEvent() {
  ...
  if (buildCounterEvent < 3) {
    o.additionalEventTypes = buildUnnamed1555();
    o.eventTimeMillis = "foo";
    o.fromUserDeletion = true;
    o.move = buildMove();
    o.permissionChanges = buildUnnamed1556();
...
checkUnnamed1557(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed1558(core.List<api.Parent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParent(o[0]);
  checkParent(o[1]);
}
...
checkUnnamed1559(core.List<api.Parent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParent(o[0]);
  checkParent(o[1]);
}
...
buildMove() {
  ...
  if (buildCounterMove < 3) {
    o.addedParents = buildUnnamed1558();
    o.removedParents = buildUnnamed1559();
  }
  buildCounterMove--;
  return o;
}
...
checkMove(api.Move o) {
  buildCounterMove++;
  if (buildCounterMove < 3) {
    checkUnnamed1558(o.addedParents);
    checkUnnamed1559(o.removedParents);
  }
  buildCounterMove--;
}
...
checkUnnamed1560(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
checkUnnamed1561(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
buildPermissionChange() {
  ...
  if (buildCounterPermissionChange < 3) {
    o.addedPermissions = buildUnnamed1560();
    o.removedPermissions = buildUnnamed1561();
  }
  buildCounterPermissionChange--;
  return o;
}
...
checkPermissionChange(api.PermissionChange o) {
  buildCounterPermissionChange++;
  if (buildCounterPermissionChange < 3) {
    checkUnnamed1560(o.addedPermissions);
    checkUnnamed1561(o.removedPermissions);
  }
  buildCounterPermissionChange--;
}
