...
buildColumn() {
  ...
  if (buildCounterColumn < 3) {
    ...
    o.name = "foo";
    o.type = "foo";
    o.validValues = buildUnnamed1327();
    o.validateData = true;
  }
  buildCounterColumn--;
  return o;
...
checkColumn(api.Column o) {
  ...
  if (buildCounterColumn < 3) {
    ...
    checkUnnamed1327(o.validValues);
...
checkUnnamed1328(core.List<api.Column> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColumn(o[0]);
  checkColumn(o[1]);
}
...
checkUnnamed1330(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1331(core.List<core.List<core.double>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLine() {
  ...
  if (buildCounterLine < 3) {
    o.coordinates = buildUnnamed1331();
    o.type = "foo";
  }
  buildCounterLine--;
  return o;
...
checkLine(api.Line o) {
  buildCounterLine++;
  if (buildCounterLine < 3) {
    checkUnnamed1331(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterLine--;
}
...
checkUnnamed1332(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
buildPoint() {
  ...
  if (buildCounterPoint < 3) {
    o.coordinates = buildUnnamed1332();
    o.type = "foo";
  }
  buildCounterPoint--;
  return o;
...
checkPoint(api.Point o) {
  buildCounterPoint++;
  if (buildCounterPoint < 3) {
    checkUnnamed1332(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterPoint--;
}
...
checkUnnamed1333(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
buildUnnamed1334() {
  var o = new core.List<core.List<core.double>>();
  o.add(buildUnnamed1333());
  o.add(buildUnnamed1333());
  return o;
}

checkUnnamed1334(core.List<core.List<core.double>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1333(o[0]);
  checkUnnamed1333(o[1]);
}

buildUnnamed1335() {
  var o = new core.List<core.List<core.List<core.double>>>();
  o.add(buildUnnamed1334());
  o.add(buildUnnamed1334());
  return o;
}

checkUnnamed1335(core.List<core.List<core.List<core.double>>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPolygon() {
  ...
  if (buildCounterPolygon < 3) {
    o.coordinates = buildUnnamed1335();
    o.type = "foo";
  }
  buildCounterPolygon--;
  return o;
...
checkPolygon(api.Polygon o) {
  buildCounterPolygon++;
  if (buildCounterPolygon < 3) {
    checkUnnamed1335(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterPolygon--;
}
...
checkUnnamed1338(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSqlresponse() {
  ...
  if (buildCounterSqlresponse < 3) {
    o.columns = buildUnnamed1336();
    o.kind = "foo";
    o.rows = buildUnnamed1338();
  }
  buildCounterSqlresponse--;
  return o;
}
...
checkSqlresponse(api.Sqlresponse o) {
  buildCounterSqlresponse++;
  if (buildCounterSqlresponse < 3) {
    checkUnnamed1336(o.columns);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1338(o.rows);
  }
  buildCounterSqlresponse--;
}
...
checkUnnamed1339(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucket(o[0]);
  checkBucket(o[1]);
}
...
checkUnnamed1340(core.List<api.StyleFunctionGradientColors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1341(core.List<api.StyleSetting> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTable() {
  ...
  if (buildCounterTable < 3) {
    ...
    o.baseTableIds = buildUnnamed1342();
    o.columnPropertiesJsonSchema = "foo";
    o.columns = buildUnnamed1343();
    o.description = "foo";
    o.isExportable = true;
    o.kind = "foo";
    o.name = "foo";
...
checkUnnamed1344(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0]);
  checkTable(o[1]);
}
...
checkUnnamed1345(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTask(o[0]);
  checkTask(o[1]);
}
...
buildTemplate() {
  ...
  if (buildCounterTemplate < 3) {
    o.automaticColumnNames = buildUnnamed1346();
    o.body = "foo";
    o.kind = "foo";
    o.name = "foo";
    o.tableId = "foo";
...
checkTemplate(api.Template o) {
  buildCounterTemplate++;
  if (buildCounterTemplate < 3) {
    checkUnnamed1346(o.automaticColumnNames);
...
checkUnnamed1347(core.List<api.Template> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTemplate(o[0]);
  checkTemplate(o[1]);
}
