...
s.copy(generator / "dart_out", "generated/googleapis", excludes=["generated/googleapis/pubspec.yaml"])
...
# copy src, test, samples directories
s.copy(generator / "dart_out_beta", "generated/googleapis_beta", excludes=["generated/googleapis_beta/pubspec.yaml"])
